...
When the bottleneck comes from news or a market-moving development, combine this lens with `demand-alpha-workflow.md`: demand must be observable, financial transmission must be clear, and the candidate must be small/pure enough for the bottleneck to matter in reported results.
